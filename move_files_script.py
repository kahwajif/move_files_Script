...
#file extensions
pic_ext = ".png", ".jpg", ".jpeg", ".gif", ".bmp", ".svg", ".psd"
...
class Handler(FileSystemEventHandler):
    ...
    def file_exists(self, dir, file_name):
        file_exists = os.path.isfile(dir + "/" + file_name)
        if file_exists:
